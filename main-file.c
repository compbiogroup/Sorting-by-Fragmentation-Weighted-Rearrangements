...
int main(int argc, char *argv[]){
  ...
  total_weight = total_weight/nperms;
  mean_break = mean_break/nperms;
  fprintf(fout, "%Lf;%Lf\n", mean_break, total_weight );
  fprintf(fout, "%s;%d;%Lf;%Lf;%ld;%ld\n", alg_name, size, mean_break, total_weight, max_weight, min_weight);

  printf("%s;%d;%Lf;%Lf;%ld;%ld\n", alg_name, size, mean_break, total_weight, max_weight, min_weight);
