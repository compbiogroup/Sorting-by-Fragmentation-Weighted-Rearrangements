...
int nofb_after_r(permutation_t *p, int i, int j, int nofbp);
int nofb_after_t(permutation_t *p, int i, int j, int k, int nofbp);
int nofb_after_rt(permutation_t *p, char rearr, int i, int j, int k, int nofbp);
int nofb_after_sig_r(permutation_t *p, int i, int j, int nofbp);
int nofb_after_sig_rt(permutation_t *p, char rearr, int i, int j, int k, int nofbp);
