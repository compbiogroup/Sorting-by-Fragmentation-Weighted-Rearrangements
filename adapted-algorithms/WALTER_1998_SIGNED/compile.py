...
# python compile.py ../output/20%%_srt_ output/rt_20%%_ > walter_signed_20%.result
# python compile.py ../output/sig_perm_srt_ output/rt_ > walter_signed_sig_perm.result

lb_output_folder = sys.argv[1]
weight_output_folder = sys.argv[2]
files = [(weight_output_folder + '%s.dist', lb_output_folder+'%s.lb')]
